...
### Horizontal Rules
Horizontal rules isually separate document sections, which can be done in 
...
seperated by `>` with no text in that line. Putting blockquotes adjacent to 
...
|`Display:` <br> `$$x^2 + y^2 = z^2$$` | Display: <br> $$x^2 + y^2 = z^2$$ |
